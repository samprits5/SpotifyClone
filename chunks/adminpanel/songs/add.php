				...
				<div class="row">
					<div class="col-12 text-center">
						<div class="main-section">
							<h2 class="content-heading">Add A New Song</h2>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group text-left">
											...
											<input type="text" name="title" class="form-control" id="song-title" aria-describedby="song-help" placeholder="Add a song title">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group text-left">
											<label for="song-description">Song Description</label>
											<input type="text" name="description" class="form-control" id="song-description" aria-describedby="song-des-help" placeholder="Add a song description">
										</div>
									</div>
								</div>
                                ...
                                <div class="row">
									<div class="col-md-6">
										<div class="form-group text-left">
											...
											<input type="text" name="length" class="form-control" id="song-length" aria-describedby="song-length-help" placeholder="Ex. 05:34">
										</div>
									</div>
									<div class="col-md-6">
